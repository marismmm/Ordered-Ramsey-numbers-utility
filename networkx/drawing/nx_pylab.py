...
def draw_networkx_edges(G, pos,
    ...
    if G.is_directed() and arrows:
        ...
        for i, (src, dst) in enumerate(edge_pos):
            ...
            #remove the minus sign to change orientation from "up" to "down"
            def invert_arrow(connection_style):
                return connection_style.replace("-", "")

            modified_connection_style = connectionstyle if edge_color[edge_processed]=='r' else invert_arrow(connectionstyle)
            ...
            arrow = FancyArrowPatch((x1, y1), (x2, y2),
                                    ...
                                    connectionstyle=modified_connection_style,
